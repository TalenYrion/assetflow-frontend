...
export function FilterSidebar({
  ...
  return (
    <aside className="w-full lg:w-64 shrink-0 lg:sticky lg:top-6 space-y-6 rounded-xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
      {/* Extension Filters */}
          ...
          {fileTypes.map((type) => (
            ...
            >
              <input
                ...
                className="h-4 w-4 rounded border-neutral-300 text-blue-600 focus:ring-blue-500 dark:border-neutral-800 dark:bg-neutral-900"
              />
              <span className="text-neutral-600 dark:text-neutral-300 group-hover:text-neutral-900 dark:group-hover:text-neutral-100 transition font-mono uppercase text-xs">
                .{type.extension}
              </span>
            </label>
          ))}
